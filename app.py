...
st.markdown("<h1 style='color: #ff9bb8;text-align: center;'>Análise exploratória de dados sobre vendas de carros:</h1>", unsafe_allow_html=True)
...
st.markdown("<p style='color: #fed7e2;'>Criando um histograma para o conjunto de dados de anúncios de vendas de carros:</p>", unsafe_allow_html=True)  
...
st.markdown("<p style='color:#fed7e2;'>Criando um gráfico de dispersão para o conjunto de dados de anúncios de vendas de carros:</p>", unsafe_allow_html=True) 
...
fig3 = px.bar(receita, x = 'condition', y='price', title='Receita média baseada na condição dos carros:',color_discrete_sequence=['pink'])
...
fig5 = px.bar(model_price, x='model', y='price', title='Preço médio por modelo',color_discrete_sequence=['pink'])
